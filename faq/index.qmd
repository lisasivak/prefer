...
You can use either R or python to develop your method (i.e. train your model). [Here](/details/overview/4submission.md){target="_blank"} we will soon add a link to the submission platform with the detailed steps how to prepare a submission and submit your method.
:::
