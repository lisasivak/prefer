...
The data should be from before 2020, because the task is to predict fertility outcomes in 2021-2023 based on information from earlier years. Exceptions are possible depending on the data, but in this case the results will not be evaluated in a standard way, so results may not be on the leaderboard.  
