...
pagetitle: FAQ
title: FAQ
subtitle: Here we answer the most common questions about PreFer (Predicting Fertility in the Netherlands data challenge). The list is updated.
...
::: {.callout-note appearance="simple" collapse="true" icon=false}
## Why predict who will have a child in the next years? Is this useful?
...
::: {.callout-note appearance="simple" collapse="true" icon=false}
## Where can I find the results of PreFer?
...
### Ethics
::: {.callout-note appearance="simple" collapse="true" icon=false}
## Doesn't predicting whether an individual will have a child in the next few years violate people's privacy? 
...
::: {.callout-note appearance="simple" collapse="true" icon=false}
## Research teams in PreFer used Dutch register data to predict fertility outcomes. This data contains detailed demographic and socio-economic information about all Dutch residents. How is this data protected?
...
All data analysis is conducted in a secure environment without internet access, and it is not possible to download the data onto personal computers. Only aggregated statistics, such as accuracy measures, can be exported; actual probabilities, such as the likelihood of having a child, cannot be exported from this environment.
