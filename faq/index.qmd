...
A data challenge is a competition where research teams compete to predict a specific characteristic using provided datasets. The winning team is determined by comparing their predictions against actual values known only to the challenge organizers.  
...
::: {.callout-note appearance="simple" collapse="true" icon=false}
## Why predict who will have a child in the next years? is this useful? Is this scientifically important?
