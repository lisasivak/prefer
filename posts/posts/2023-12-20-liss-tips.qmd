...
We made the codebooks for the merged files in a machine-readable *.csv* format. You can find them here [add link]. Using these codebooks you can e.g. get a full list of variables from a certain Core study.
